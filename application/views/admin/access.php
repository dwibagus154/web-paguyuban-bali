							...
							<tr>
								...
								<td>
									<div class="form-check">
									  <input class="form-check-input checkaccesss" type="checkbox" <?= is_access($role['id'], $m['id']); ?> data-role ="<?= $role['id']; ?>" data-menu ="<?= $m['id'] ?>" >
									  <!-- fungsi datamenu dan dataid untuk dikirim ke file foote jquery -->
									</div>
								</td>
							</tr>
							<?php } ?>
